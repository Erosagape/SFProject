<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fileadmin.aspx.cs" Inherits="sfdelivery.fileadmin" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:ListBox ID="ListBox1" runat="server" Height="313px" Width="153px"></asp:ListBox>
    </div>
