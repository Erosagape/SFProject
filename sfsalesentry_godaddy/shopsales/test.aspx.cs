...
namespace shopsales
{
    public partial class test1 : System.Web.UI.Page
    {
        ...
        {
            IService svc = new IService();
            Label1.Text =svc.SendDailyReport(ClsUtil.GetCurrentTHDate().ToString ("yyyy-MM-dd"),"เรียนผู้เกี่ยวข้อง");
        }
        ...
        {
            IService svc = new IService();
            string ondate = ClsUtil.GetCurrentTHDate().ToString("yyyy-MM-dd");
